...
export default function AlunoUpdate() {
    ...
    const carregarAluno = async () => {
        if (!id) {
            Alert.alert("Erro", "ID do aluno não fornecido!");
            router.back();
            return;
        }
        ...
        try {
            ...
            if (user.admin) {
                if (Platform.OS === "web") {
                    alert("Este usuário é um professor, não um aluno!");
                } else {
                    Alert.alert("Erro", "Este usuário é um professor, não um aluno!");
                }
                router.back();
                return;
            }
            ...
            Alert.alert(
                "Erro",
                "Não foi possível carregar o aluno. Tente novamente.",
                ...
                <View style={styles.infoBox}>
                    <Text style={styles.infoText}>
                        * Campos obrigatórios{'\n'}
                        ...
                        • O aluno manterá o acesso padrão ao sistema
                    </Text>
                </View>
